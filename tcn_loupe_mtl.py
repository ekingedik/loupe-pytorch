...
class TCNModel(nn.Module):
    def __init__(
        ...
        self.fc_eff = nn.Linear(
            int(self.cluster_output_dim * 2), self.cluster_output_dim
        )
        ...
        self.out_eff = nn.Linear(self.cluster_output_dim, output_dim)
        self.out_fst = nn.Linear(self.cluster_output_dim, output_dim)
        self.out_sts = nn.Linear(self.cluster_output_dim, output_dim)
        self.device = device
